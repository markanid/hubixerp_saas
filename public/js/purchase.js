$(document).ready(function() {
    ...
    document.addEventListener('keydown', function (event) {
        ...
        scannedProductRequest = $.getJSON(purchaseSearchRoute, {query: term, searchBy: 'product'})
            .done(function (items) {
                ...
                if (!result) {
                    showPurchaseWarningToast('Product Search', matches.length
            ...
            .fail(function (xhr, status) {
                if (version === scannedProductVersion && status !== 'abort') {
                    showPurchaseWarningToast('Product Search', 'Could not load the product. Please scan again.');
                }
            })
            .always(function () {
